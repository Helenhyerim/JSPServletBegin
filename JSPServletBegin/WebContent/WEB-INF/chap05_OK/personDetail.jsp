...
<script type="text/javascript">
   ...
   function deletePerson() {
	   ...
	   const bool = window.confirm("정말로 삭제하시겠습니까?"); // window. 생략가능
	   
	   if(bool){
		   const frm = document.delFrm;
		   // console.log("확인용 삭제할 회원번호 => " + frm.seq.value);
	   ...
	   <div class="card">
	      ...
	      <div class="card-footer">  <%-- .card-footer 에는 카드 꼬리말이 들어갑니다. --%>
	      	<div class="row" style="position: relative; top:10px;">
	      		...
	      		<div class="col-md-3">
	      			<p class="text-center">
	      				<button type="button" class="btn btn-primary" onclick="updatePerson()">내정보 수정하기</button>
	      			</p>
	      		</div>
	      	</div>
	      </div>
