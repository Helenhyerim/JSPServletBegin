	...
	*/
	// 또는
		...
		$("form[name='memberFrm']").submit(() => {
			...
			// 3. 색상은 필수입력 검사
			const color_checked_length = $("input:radio[name='color']:checked").length; // 체크되어진 것이 몇개인지
			...
			// 4. 음식은 필수입력 검사
			const food_checked_length = $("input:checkbox[name='food']:checked").length; // 체크되어진 것이 몇개인지
