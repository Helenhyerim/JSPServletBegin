...
<head>
<meta charset="UTF-8">
<title>1부터 10까지의 합을 자바에서 구한 다음, 결과를 html 로 보이게 한다.</title>
<style type="text/css">
	span#result {
		color: green;
	}
...
<body>
<% 
	// 스크립틀릿(scriptlet) 이라고 부르고, 자바코드가 들어온다.
...
<%--
	 <% 로 시작하여 %>로 끝나는 것을 "스크립틀릿(scriptlet)" 이라고 부른다. 
       ...
       =================================================
       01oneToTenSum.jsp 라는 파일은 실제로는 확장자 .java 파일로 저장되어서 컴파일 되어진 확장자 .class 파일로 저장되어지는데,
             어느 경로에 저장되어지는지 알아본다.
